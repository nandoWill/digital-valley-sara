...
//			e1.setDescricao("Evento para apresenta��o de trabalhos desenvolvidos pelos alunos");
...
//			t1.setDescricao("Trilha para submiss�o de trabalhos de pesquisa");
//			t1.setEvento(eventoController.buscar(1));
//			
//			Trilha t2 = new Trilha();
//			t2.setNome("Trabalhos de Extens�o");
//			t2.setDescricao("Trilha para submiss�o de trabalhos de extens�o");
